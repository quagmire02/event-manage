            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <div class="mb-3">
                            <label for="current_semester" class="form-label">{{ __('Current Semester') }}</label>
                            <input id="current_semester" type="text" class="form-control @error('current_semester') is-invalid @enderror" name="current_semester" value="{{ old('current_semester', $profile->current_semester ?? '') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="department" type="text" class="form-control @error('department') is-invalid @enderror" name="department" value="{{ old('department', $profile->department ?? '') }}">
                            @error('department')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
